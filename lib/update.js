 ...
 * dsh-remote-tunnel-easy@latest`) rather than inventing a second update path.
 *
...
export const PACKAGE_NAME = 'dsh-remote-tunnel-easy'
 ...
 * `$DSH_HOME/profiles/*` for a `node_modules/dsh-remote-tunnel-easy` whose
